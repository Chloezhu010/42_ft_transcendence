 ...
 * Renders signup form and handles signup logic.
 */
...
export function SignupPage(): JSX.Element {
    ...
    async function handleSubmit(e: React.FormEvent): Promise<void> {
        ...
        try {
            // Attempt to sign up with the provided email, username, and password
    ...
    return (
        <div className="flex flex-1 items-center justify-center py-12">
            <div className="w-full max-w-md bg-white rounded-2xl border-4 border-brand-primary/20 shadow-soft p-10">
                <h1 className="font-sans font-bold text-3xl text-brand-dark text-center mb-8">Create your account</h1>
                <form onSubmit={handleSubmit}>
                    <div className="space-y-6">
                        ...
                        <div>
                            <label className="block text-sm font-bold text-brand-muted mb-2">Username</label>
                            <SketchyInput
                                type="text"
                                value={username}
